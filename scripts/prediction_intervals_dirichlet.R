...
modobj <- mgrow # calls best model fit object `modobj`
...
modobj <- mmort # calls best model fit object `modobj`
...
modobj <- mrec # calls best model fit object `modobj`
